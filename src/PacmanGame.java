...
public class PacmanGame extends JPanel {
    ...
    public PacmanGame() {
        ...
        ghostImage = new ImageIcon("src/resources/ghost.png").getImage();
        blueGhost = new ImageIcon("src/resources/blueghost.png").getImage();
        wallImage = new ImageIcon("src/resources/wall.png").getImage();
        ghostRespawn = new ImageIcon("src/resources/respawn.png").getImage();
        pelletImage = new ImageIcon("src/resources/pellet.png").getImage();
        powerImage = new ImageIcon("src/resources/power.png").getImage();
     ...
     // Create the info button
        ...
        topPanel.add(elementSelector);
        topPanel2.add(scoreLabel);
        topPanel2.add(loadMap);
        ...
        topPanel.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 10)); //gapsize change 10 to however big I want gap
        ...
        bottomPanel.add(topPanel, BorderLayout.WEST);
        bottomPanel.add(topPanel2, BorderLayout.CENTER);
